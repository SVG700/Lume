      ...
      <Reveal className="section-panel" delay={260}>
        <div className="grid items-center gap-8 lg:grid-cols-[1fr_1fr]">
          <div className="rounded-3xl flex items-center justify-center p-6">
            <div className="relative mx-auto h-64 w-full max-w-sm rounded-3xl p-6 bg-gradient-to-br from-slate-800 to-slate-900 shadow-2xl">
          ...
          <div>
            ...
            <h2 className="mt-3 text-4xl font-bold text-white">LUME USB</h2>
            ...
            <div className="mt-6 flex items-end justify-between gap-4 rounded-2xl p-4 glass-card">
              <div>
              ...
              <div className="flex flex-wrap gap-3">
                <button
                  ...
                  className="rounded-full bg-gradient-to-r from-blue-500 to-violet-500 px-5 py-2.5 text-sm font-semibold text-white shadow-md transition hover:-translate-y-0.5"
                >
                  Buy Now
                </button>
                <a
                  href="#prototype"
                  className="rounded-full border border-slate-700 px-5 py-2.5 text-sm font-semibold text-slate-200 hover:bg-slate-800/30"
                >
                  Learn More
                </a>
              </div>
